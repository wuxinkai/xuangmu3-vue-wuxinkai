...
function GradientParticles(options) {
  ...
  options = options || {};
  var color = (options.color !== undefined) ? new THREE.Color(options.color) : new THREE.Color(0x0419ff);
...
GradientParticles.prototype = Object.create(THREE.Points.prototype);
